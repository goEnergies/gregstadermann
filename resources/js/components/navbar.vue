<template>
<div class="w-full">
<nav class="mb-4 relative select-none bg-indigo-darkest text-indigo-lightest lg:flex lg:items-stretch">
  <div class="flex flex-no-shrink items-stretch h-12">
<div class="flex items-center flex-no-shrink text-white ml-1 mr-4">
 <svg class="fill-current h-8 w-8 mr-2" width="54" height="54" viewBox="0 0 54 54" xmlns="http://www.w3.org/2000/svg"><path d="M13.5 22.1c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05zM0 38.3c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05z"/></svg>
    ...
    <a href="#" class="flex-no-grow flex-no-shrink relative py-2 px-4 leading-normal text-white no-underline flex items-center hover:text-indigo-lightest hover:bg-indigo-dark">
<div class="dropdown"><a class="text-white no-underline" href="#">Menu</a> <div class="dropdown-content bg-indigo"> <a class="bg-indigo" href="#">List</a> </div> </div>
</a>
